    ...
    <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 disabled:cursor-not-allowed"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-12 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div className="p-4 bg-gray-50 rounded-xl">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">How long we keep your data</p>
                    </div>
                    <button 
              ...
              <div className="pt-6 border-t border-gray-200">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full flex items-center justify-center space-x-2 bg-gray-100 text-gray-700 px-6 py-3 rounded-xl font-semibold hover:bg-gray-200 transition-all"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center space-x-2 bg-red-50 text-red-600 px-6 py-3 rounded-xl font-semibold hover:bg-red-100 border-2 border-red-200 transition-all"
                  >
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          ...
          >
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Enable 2FA</h2>
            ...
            <div className="space-y-4 mb-6">
              <div className="p-4 bg-gray-50 rounded-xl">
                <div className="flex items-center justify-center mb-4">
                  <div className="w-48 h-48 bg-white p-4 rounded-xl border-2 border-gray-200">
                    <div className="w-full h-full bg-gradient-to-br from-blue-100 to-cyan-100 rounded-lg flex items-center justify-center">
                      <p className="text-xs text-gray-600 text-center">QR Code<br />Placeholder</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-4 bg-blue-50 border-2 border-blue-200 rounded-xl">
                <p className="text-sm font-medium text-blue-900 mb-2">Backup Code:</p>
                <code className="block text-center text-lg font-mono text-blue-700 bg-white p-3 rounded-lg">
                  XXXX-XXXX-XXXX-XXXX
                </code>
                <p className="text-xs text-blue-600 mt-2">Save this code in a safe place</p>
              </div>
            </div>
            ...
            <div className="flex space-x-3">
              <button
                onClick={() => {
                  ...
                  toast.success('2FA will be fully functional after backend integration!');
                }}
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600">Manage devices logged into your account</p>
              </div>
              <button
            ...
            <button
              ...
              className="w-full mt-4 bg-red-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-red-700 transition-all"
            >
      ...
      {showRetentionModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          ...
          >
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Data Retention Settings</h2>
              <p className="text-gray-600">Choose how long we keep your data</p>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="p-4 bg-blue-50 border-2 border-blue-200 rounded-xl">
                <label className="flex items-start space-x-3 cursor-pointer">
                  ...
                  />
                  <div>
                    <p className="font-semibold text-gray-900">Keep Forever</p>
                    <p className="text-sm text-gray-600">All your data is stored indefinitely</p>
                  </div>
                </label>
              </div>
              ...
              <div className="p-4 bg-gray-50 border-2 border-gray-200 rounded-xl">
                <label className="flex items-start space-x-3 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Data older than 1 year is automatically deleted</p>
                  </div>
                </label>
              </div>
              ...
              <div className="p-4 bg-gray-50 border-2 border-gray-200 rounded-xl">
                <label className="flex items-start space-x-3 cursor-pointer">
                  <input type="radio" name="retention" className="mt-1" />
                  <div>
                    <p className="font-semibold text-gray-900">6 Months Retention</p>
                    <p className="text-sm text-gray-600">Data older than 6 months is automatically deleted</p>
                  </div>
                </label>
              </div>
              ...
              <div className="p-4 bg-gray-50 border-2 border-gray-200 rounded-xl">
                <label className="flex items-start space-x-3 cursor-pointer">
                  <input type="radio" name="retention" className="mt-1" />
                  <div>
                    <p className="font-semibold text-gray-900">3 Months Retention</p>
                    <p className="text-sm text-gray-600">Data older than 3 months is automatically deleted</p>
                  </div>
                </label>
              </div>
            </div>
